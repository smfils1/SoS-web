const template = {
  brandName: "AS/WA LABS",
  brandLogo: require("../assets/images/logo_transparent.png"),
  homeTitle: {
    top: "Shoot",
    middle: "or",
    bottom: "Survive",
  },
  heroImage: require("../assets/images/gp7.jpg"),
  ...
  galleryImages: [
    ...
    require("../assets/images/sm_gp12.jpg"),
    require("../assets/images/sm_gp4.jpg"),
    require("../assets/images/sm_gp5.jpg"),
    require("../assets/images/sm_gp9.jpg"),
    require("../assets/images/sm_gp10.jpg"),
    require("../assets/images/sm_gp11.jpg"),
    require("../assets/images/sm_gp3.jpg"),
    require("../assets/images/sm_gp13.jpg"),
    require("../assets/images/sm_gp8.jpg"),
  ],
